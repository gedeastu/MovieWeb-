...
function Header () {
  ...
  return (
    ...
    <div id="header" className='max-w-full'>
      <div id="navbar" className='flex justify-between items-center px-5 py-3 w-full bg-[#080B10]/10 backdrop-blur-lg fixed z-50 md:pt-4'>
        ...
        <div id='searchDesktop' className='flex items-center gap-2'>
          <button id='filter' onClick={()=> navigate('/filter')} className='hidden bg-[#704DB9] w-20 h-8 rounded-lg md:flex md:justify-center md:gap-2 md:items-center'>
          ...
          <div id="fieldSearch" className='hidden md:flex'>
            <div id="search" className='flex items-center justify-evenly gap-3'>
              <input type="text" className='rounded-2xl w-[23rem] h-10 text-white font-semibold bg-white/10' placeholder='Search movies / tv series...'/>
        ...
        <button id='signIn' className="bg-[#704DB9] w-24 h-10 flex justify-evenly items-center rounded-xl" onClick={()=>window.modal_signIn.showModal()}>
              ...
              <div className="hidden duration-1000 delay-300 ease-in-out" data-carousel-item>
                <div id="pict1" className="bg-cover bg-center w-full h-full relative flex flex-col">
                    ...
                    <div id="content" className='flex flex-col gap-2.5 justify-end pb-5 bg-gradient-to-t from-[#080B10] to-transparent w-full h-full'>
                      ...
                      <h1 className='uppercase text-xl text-white font-bold text-center mb-0'>
                      ...
                      <p>140 min</p>
                        ...
                        <div id="narration" className='hidden w-[50rem] text-sm my-2 text-center mx-auto md:flex'>
                      ...
                      <div id="btn_watch" className='flex w-max mx-auto gap-2'>
                          ...
                          <button id='bookmark' className='font-semibold flex items-center gap-2 bg-transparent backdrop-blur-lg border border-[#704DB9] text-white py-1.5 px-3 rounded-2xl'>
                            <p>Add Bookmark</p>
              ...
              <div className="hidden duration-1000 delay-300 ease-in-out" data-carousel-item>
                <div id="pict2" className="bg-cover bg-center w-full h-full relative flex flex-col">
                    ...
                    <div id="content" className='flex flex-col gap-2.5 justify-end pb-5 bg-gradient-to-t from-[#080B10] to-transparent w-full h-full'>
                      ...
                      <div id="narration" className='hidden w-[43rem] text-sm my-2 text-center mx-auto md:flex'>
                          <p>
    ...
    <dialog id="modal_search" className="modal">
          <form method="dialog" className="modal-box bg-[#704DB9] text-white">
            ...
            <button id='filter' onClick={()=> navigate('/filter')} className='bg-white w-28 h-10 rounded-xl flex justify-center gap-1.5 items-center'>
    ...
    <dialog id="modal_signIn" className="modal">
          <form method="dialog" className="modal-box bg-[#704DB9] text-white flex flex-col gap-3">
            <div className="modal-action absolute -top-3.5 right-3">
            ...
            <div id="username" className='bg-white rounded-xl'>
              <div id='title' className='flex items-center pt-2 px-2 gap-2'>
              <svg className='fill-[#704DB9]' xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 512 512"><path d="M399 384.2C376.9 345.8 335.4 320 288 320H224c-47.4 0-88.9 25.8-111 64.2c35.2 39.2 86.2 63.8 143 63.8s107.8-24.7 143-63.8zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 16a72 72 0 1 0 0-144 72 72 0 1 0 0 144z"/></svg>
              <h3 className='text-[#704DB9] font-medium'>Account</h3>
              </div>
              <input type="text" className='bg-transparent w-full text-black border-none font-semibold focus:outline-none focus:ring-0 focus:border-none' placeholder='Username or e-mail'/>
            </div>
            <div id="password" className='bg-white rounded-xl'>
              <div id='title' className='flex items-center pt-2 px-2 gap-2'>
              <svg className='fill-[#704DB9]' xmlns="http://www.w3.org/2000/svg" height="1.3em" viewBox="0 0 448 512"><path d="M144 144v48H304V144c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192V144C80 64.5 144.5 0 224 0s144 64.5 144 144v48h16c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V256c0-35.3 28.7-64 64-64H80z"/></svg>
              <h3 className='text-[#704DB9] font-medium'>Password</h3>
              </div>
              <input type="text" className='bg-transparent w-full text-black border-none font-semibold focus:outline-none focus:ring-0 focus:border-none' placeholder='Your password'/>
            </div>
            <button id='Login' className='flex items-center justify-center gap-2 bg-green-500 py-2 rounded-xl border border-white/20'>
